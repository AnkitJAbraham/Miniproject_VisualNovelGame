			...
			<div className="fixed top-0 w-full z-50">
				<nav className="border-gray-200 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black select-none">
					<div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 relative">
						...
						<button
							type="button"
							className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm rounded-lg md:hidden focus:outline-none focus:ring-2 focus:bg-gray-700 focus:ring-gray-600"
						...
						>
							<ul className="font-medium flex flex-col p-4  border rounded-lg border-gray-700">
								<li>
									<Link
										href="/"
										className={`block py-1 px-3 rounded ${isLinkActive('/')}`}
									>
										Home
									</Link>
								</li>
