...
export default function Footer() {
	return (
		<div className="container mx-auto pb-8 px-4">
			...
			<div className="flex flex-wrap justify-center pl-3 md:pl-0 md:items-center mt-2 text-2xl">
				...
				>
					<svg
						...
						height="24"
						viewBox="0 0 24 24"
						className="invert transition-transform hover:scale-125 hover:shadow-[0px_0px_20px_6px_rgba(247,_143,_71,_0.7)]"
					>
