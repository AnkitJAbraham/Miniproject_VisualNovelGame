...
export default function ContainerBlock({children, ...customMeta}) {
	...
	return (
		<div>
			...
			<main className="flex flex-col gap-20 md:gap-8 items-center bg-gradient-to-r from-[#000] via-[#00021f] to-[#051323] background-animate text-white overflow-x-hidden">
